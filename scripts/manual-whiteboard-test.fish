...
if test $result -eq 0
    ...
    echo "Entering bounded camera management at 0.8x with a monitor-local pan..."
    if not whiteboard_dispatch "function() hl.plugin.whiteboard.setCamera('$monitor', $workspace, 0.8, 120, -80) end"
